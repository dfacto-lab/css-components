...
export type PolymorphicComponentProps<C extends React.ElementType, Props = Record<string, unknown>> = InheritableElementProps<C, Props>;
 ...
 */
export type PolymorphicComponent<E extends React.ElementType, V extends variantsType | object> = React.FC<PolymorphicComponentPropsWithRef<E, VariantOptions<V>>>;
/**
 ...
 */
export type VariantProps<C extends keyof JSX.IntrinsicElements | JSXElementConstructor<any>> = React.ComponentProps<C>;
/**
 ...
 */
export type BooleanIfStringBoolean<T> = T extends "true" | "false" ? boolean : T;
/**
